...
if ($_SERVER['REQUEST_METHOD'] === 'GET'){
    if (isset($_GET['id'])){ //retrieve single row
        ...
        $data = array();
        $sql = $con->query("SELECT attendance.atten_id, students.name, attendance.sub_name, CONVERT_TZ(attendance.create_time,'+00:00','+08:30') AS create_time FROM attendance JOIN students ON students.name = attendance.name");
